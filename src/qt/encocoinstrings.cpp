...
QT_TRANSLATE_NOOP("encocoin-core", "Encocoin Core"),
QT_TRANSLATE_NOOP("encocoin-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("encocoin-core", ""
"Disable all Encocoin specific functionality (Masternodes, PrivateSend, "
...
QT_TRANSLATE_NOOP("encocoin-core", "%s is not a valid backup folder!"),
QT_TRANSLATE_NOOP("encocoin-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("encocoin-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("encocoin-core", "(default: %s)"),
QT_TRANSLATE_NOOP("encocoin-core", "(default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("encocoin-core", "(press q to shutdown and continue later)"),
QT_TRANSLATE_NOOP("encocoin-core", "-devnet can only be specified once"),
QT_TRANSLATE_NOOP("encocoin-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("encocoin-core", "-port must be specified when -devnet and -listen are specified"),
QT_TRANSLATE_NOOP("encocoin-core", "-rpcport must be specified when -devnet and -server are specified"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Allow RFC1918 addresses to be relayed and connected to (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Already have that input."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("encocoin-core", "Automatic backups disabled"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("encocoin-core", "Can't mix while sync in progress."),
QT_TRANSLATE_NOOP("encocoin-core", "Can't mix: no compatible inputs found!"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("encocoin-core", "Change index out of range"),
QT_TRANSLATE_NOOP("encocoin-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("encocoin-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("encocoin-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Copyright (C)"),
...
QT_TRANSLATE_NOOP("encocoin-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("encocoin-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("encocoin-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Enable transaction replacement in the memory pool (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Entries are full."),
QT_TRANSLATE_NOOP("encocoin-core", "Entry exceeds maximum size."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("encocoin-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to find mixing queue to join"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to load fulfilled requests cache from"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to load governance cache from"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to load masternode cache from"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to load masternode payments cache from"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("encocoin-core", "Failed to start a new mixing queue"),
QT_TRANSLATE_NOOP("encocoin-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("encocoin-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("encocoin-core", "Found enough users, signing ..."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("encocoin-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("encocoin-core", "Incompatible version."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Initialization sanity check failed. %s is shutting down."),
QT_TRANSLATE_NOOP("encocoin-core", "Input is not valid."),
QT_TRANSLATE_NOOP("encocoin-core", "InstantSend options:"),
QT_TRANSLATE_NOOP("encocoin-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("encocoin-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("encocoin-core", "Invalid -proxy address: '%s'"),
QT_TRANSLATE_NOOP("encocoin-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("encocoin-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("encocoin-core", "Invalid spork address specified with -sporkaddr"),
QT_TRANSLATE_NOOP("encocoin-core", "KeePassHttp id for the established association"),
QT_TRANSLATE_NOOP("encocoin-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("encocoin-core", "Keep N XNK anonymized (%u-%u, default: %u)"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("encocoin-core", "Last PrivateSend was too recent."),
QT_TRANSLATE_NOOP("encocoin-core", "Last successful PrivateSend action was too recent."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Loading fulfilled requests cache..."),
QT_TRANSLATE_NOOP("encocoin-core", "Loading governance cache..."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Lock is already in place."),
QT_TRANSLATE_NOOP("encocoin-core", "Lock masternodes from masternode configuration file (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("encocoin-core", "Masternode cache is empty, skipping payments and governance cache..."),
QT_TRANSLATE_NOOP("encocoin-core", "Masternode options:"),
QT_TRANSLATE_NOOP("encocoin-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("encocoin-core", "Masternode:"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("encocoin-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("encocoin-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
QT_TRANSLATE_NOOP("encocoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("encocoin-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("encocoin-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("encocoin-core", "No errors detected."),
QT_TRANSLATE_NOOP("encocoin-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("encocoin-core", "Node relay options:"),
QT_TRANSLATE_NOOP("encocoin-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("encocoin-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("encocoin-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("encocoin-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("encocoin-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("encocoin-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Port: %d"),
QT_TRANSLATE_NOOP("encocoin-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("encocoin-core", "Print version and exit"),
QT_TRANSLATE_NOOP("encocoin-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("encocoin-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("encocoin-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("encocoin-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("encocoin-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("encocoin-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("encocoin-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("encocoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("encocoin-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("encocoin-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("encocoin-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("encocoin-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Session not complete!"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Starting network threads..."),
QT_TRANSLATE_NOOP("encocoin-core", "Submitted following entries to masternode: %u / %d"),
QT_TRANSLATE_NOOP("encocoin-core", "Submitted to masternode, waiting for more entries ( %u / %d ) %s"),
QT_TRANSLATE_NOOP("encocoin-core", "Submitted to masternode, waiting in queue %s"),
QT_TRANSLATE_NOOP("encocoin-core", "Synchroning blockchain..."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("encocoin-core", "Synchronizing masternode payments..."),
QT_TRANSLATE_NOOP("encocoin-core", "Synchronizing masternodes..."),
QT_TRANSLATE_NOOP("encocoin-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("encocoin-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("encocoin-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("encocoin-core", "This is experimental software."),
QT_TRANSLATE_NOOP("encocoin-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("encocoin-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("encocoin-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("encocoin-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Too many %f denominations, removing."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("encocoin-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("encocoin-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("encocoin-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("encocoin-core", "Transaction must have at least one recipient"),
QT_TRANSLATE_NOOP("encocoin-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("encocoin-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("encocoin-core", "Trying to connect..."),
QT_TRANSLATE_NOOP("encocoin-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("encocoin-core", "Unable to bind to %s on this computer. %s is probably already running."),
...
QT_TRANSLATE_NOOP("encocoin-core", "Unknown response."),
QT_TRANSLATE_NOOP("encocoin-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("encocoin-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("encocoin-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("encocoin-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("encocoin-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("encocoin-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("encocoin-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Use devnet chain with provided name"),
QT_TRANSLATE_NOOP("encocoin-core", "Use the test chain"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Very low number of keys left: %d"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("encocoin-core", "Wallet needed to be rewritten: restart %s to complete"),
...
QT_TRANSLATE_NOOP("encocoin-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("encocoin-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("encocoin-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("encocoin-core", "Will retry..."),
QT_TRANSLATE_NOOP("encocoin-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("encocoin-core", "Your transaction was accepted into the pool!"),
...
QT_TRANSLATE_NOOP("encocoin-core", "no mixing available."),
QT_TRANSLATE_NOOP("encocoin-core", "see debug.log for details."),
};
