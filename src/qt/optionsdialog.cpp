    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XNK-light"), QVariant("light"));
    ui->theme->addItem(QString("XNK-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XNK-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("XNK-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("XNK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XNK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XNK-traditional"), QVariant("trad"));
