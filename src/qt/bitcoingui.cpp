...
void BitcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Encocoin command-line options").arg(tr(PACKAGE_NAME)));
