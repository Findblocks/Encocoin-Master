...
All the Encocoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XNK, 0.1 XNK, 1 XNK and 10 XNK -- sort of like the paper money you use every day.</li> \
