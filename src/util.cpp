...
const char * const BITCOIN_CONF_FILENAME = "encocoin.conf";
const char * const BITCOIN_PID_FILENAME = "encocoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Encocoin";
#else
    // Unix
...
void ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good()){
        // Create empty encocoin.conf if it does not excist
