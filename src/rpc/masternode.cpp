...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Encocoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "encocoin",               "masternode",             &masternode,             true,  {} },
    { "encocoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "encocoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "encocoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "encocoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "encocoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
