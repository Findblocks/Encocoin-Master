...
This mechanism has been integrated into Bitcore-Node-Encocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/encocoinpay/insight-api-encocoin#web-socket-api](https://github.com/encocoinpay/insight-api-encocoin#web-socket-api)
* API: [https://github.com/encocoinpay/insight-api-encocoin#instantsend-transactions](https://github.com/encocoinpay/insight-api-encocoin#instantsend-transactions)
...
By default, the Encocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Encocoin Core daemon:
